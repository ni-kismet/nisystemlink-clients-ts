 ...
 */
export const deleteTable = <ThrowOnError extends boolean = false>(options: Options<DeleteTableData, ThrowOnError>): RequestResult<DeleteTableResponses, DeleteTableErrors, ThrowOnError> => (options.client ?? client).delete<DeleteTableResponses, DeleteTableErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const modifyTable = <ThrowOnError extends boolean = false>(options: Options<ModifyTableData, ThrowOnError>): RequestResult<ModifyTableResponses, ModifyTableErrors, ThrowOnError> => (options.client ?? client).patch<ModifyTableResponses, ModifyTableErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/nidataframe/v1/tables/{id}',
    ...options,
    headers: {
 ...
 */
export const deleteTables = <ThrowOnError extends boolean = false>(options?: Options<DeleteTablesData, ThrowOnError>): RequestResult<DeleteTablesResponses, DeleteTablesErrors, ThrowOnError> => (options?.client ?? client).post<DeleteTablesResponses, DeleteTablesErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const modifyTables = <ThrowOnError extends boolean = false>(options?: Options<ModifyTablesData, ThrowOnError>): RequestResult<ModifyTablesResponses, ModifyTablesErrors, ThrowOnError> => (options?.client ?? client).post<ModifyTablesResponses, ModifyTablesErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const rootEndpoint = <ThrowOnError extends boolean = false>(options?: Options<RootEndpointData, ThrowOnError>): RequestResult<RootEndpointResponses, unknown, ThrowOnError> => (options?.client ?? client).get<RootEndpointResponses, unknown, ThrowOnError>({ url: '/nidataframe', ...options });
 ...
 */
export const rootEndpointWithVersion = <ThrowOnError extends boolean = false>(options: Options<RootEndpointWithVersionData, ThrowOnError>): RequestResult<RootEndpointWithVersionResponses, RootEndpointWithVersionErrors, ThrowOnError> => (options.client ?? client).get<RootEndpointWithVersionResponses, RootEndpointWithVersionErrors, ThrowOnError>({ url: '/nidataframe/{version}', ...options });
