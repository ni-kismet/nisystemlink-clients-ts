 ...
 */
export const listServiceGroups = <ThrowOnError extends boolean = false>(options?: Options<ListServiceGroupsData, ThrowOnError>): RequestResult<ListServiceGroupsResponses, ListServiceGroupsErrors, ThrowOnError> => (options?.client ?? client).get<ListServiceGroupsResponses, ListServiceGroupsErrors, ThrowOnError>({
 ...
 */
export const listAvailableFiles = <ThrowOnError extends boolean = false>(options?: Options<ListAvailableFilesData, ThrowOnError>): RequestResult<ListAvailableFilesResponses, ListAvailableFilesErrors, ThrowOnError> => (options?.client ?? client).get<ListAvailableFilesResponses, ListAvailableFilesErrors, ThrowOnError>({
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 */
export const receiveFile = <ThrowOnError extends boolean = false>(options: Options<ReceiveFileData, ThrowOnError>): RequestResult<ReceiveFileResponses, ReceiveFileErrors, ThrowOnError> => (options.client ?? client).get<ReceiveFileResponses, ReceiveFileErrors, ThrowOnError>({
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 */
export const updateMetadata = <ThrowOnError extends boolean = false>(options: Options<UpdateMetadataData, ThrowOnError>): RequestResult<UpdateMetadataResponses, UpdateMetadataErrors, ThrowOnError> => (options.client ?? client).post<UpdateMetadataResponses, UpdateMetadataErrors, ThrowOnError>({
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 */
export const deleteMultiple = <ThrowOnError extends boolean = false>(options: Options<DeleteMultipleData, ThrowOnError>): RequestResult<DeleteMultipleResponses, DeleteMultipleErrors, ThrowOnError> => (options.client ?? client).post<DeleteMultipleResponses, DeleteMultipleErrors, ThrowOnError>({
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 */
export const queryAvailableFiles = <ThrowOnError extends boolean = false>(options?: Options<QueryAvailableFilesData, ThrowOnError>): RequestResult<QueryAvailableFilesResponses, QueryAvailableFilesErrors, ThrowOnError> => (options?.client ?? client).post<QueryAvailableFilesResponses, QueryAvailableFilesErrors, ThrowOnError>({
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 */
export const queryFilesLinq = <ThrowOnError extends boolean = false>(options?: Options<QueryFilesLinqData, ThrowOnError>): RequestResult<QueryFilesLinqResponses, QueryFilesLinqErrors, ThrowOnError> => (options?.client ?? client).post<QueryFilesLinqResponses, QueryFilesLinqErrors, ThrowOnError>({
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 */
export const searchFiles = <ThrowOnError extends boolean = false>(options?: Options<SearchFilesData, ThrowOnError>): RequestResult<SearchFilesResponses, SearchFilesErrors, ThrowOnError> => (options?.client ?? client).post<SearchFilesResponses, SearchFilesErrors, ThrowOnError>({
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 */
export const uploadSessionStart = <ThrowOnError extends boolean = false>(options?: Options<UploadSessionStartData, ThrowOnError>): RequestResult<UploadSessionStartResponses, UploadSessionStartErrors, ThrowOnError> => (options?.client ?? client).post<UploadSessionStartResponses, UploadSessionStartErrors, ThrowOnError>({
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 */
export const uploadSessionAppend = <ThrowOnError extends boolean = false>(options: Options<UploadSessionAppendData, ThrowOnError>): RequestResult<UploadSessionAppendResponses, UploadSessionAppendErrors, ThrowOnError> => (options.client ?? client).post<UploadSessionAppendResponses, UploadSessionAppendErrors, ThrowOnError>({
    ...formDataBodySerializer,
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 */
export const uploadSessionFinish = <ThrowOnError extends boolean = false>(options: Options<UploadSessionFinishData, ThrowOnError>): RequestResult<UploadSessionFinishResponses, UploadSessionFinishErrors, ThrowOnError> => (options.client ?? client).post<UploadSessionFinishResponses, UploadSessionFinishErrors, ThrowOnError>({
    security: [{ name: 'x-ni-api-key', type: 'apiKey' }],
 ...
 * @deprecated
 */
export const ping = <ThrowOnError extends boolean = false>(options?: Options<PingData, ThrowOnError>): RequestResult<PingResponses, unknown, ThrowOnError> => (options?.client ?? client).get<PingResponses, unknown, ThrowOnError>({ url: '/v1/ping', ...options });
