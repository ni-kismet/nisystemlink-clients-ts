 ...
 */
export const getFeedById = <ThrowOnError extends boolean = false>(options: Options<GetFeedByIdData, ThrowOnError>): RequestResult<GetFeedByIdResponses, GetFeedByIdErrors, ThrowOnError> => (options.client ?? client).get<GetFeedByIdResponses, GetFeedByIdErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/nifeed/v1/feeds/{feedId}',
    ...options
});
 ...
 */
export const updateFeedMetadata = <ThrowOnError extends boolean = false>(options: Options<UpdateFeedMetadataData, ThrowOnError>): RequestResult<UpdateFeedMetadataResponses, UpdateFeedMetadataErrors, ThrowOnError> => (options.client ?? client).patch<UpdateFeedMetadataResponses, UpdateFeedMetadataErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const deleteFeeds = <ThrowOnError extends boolean = false>(options?: Options<DeleteFeedsData, ThrowOnError>): RequestResult<DeleteFeedsResponses, DeleteFeedsErrors, ThrowOnError> => (options?.client ?? client).post<DeleteFeedsResponses, DeleteFeedsErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const downloadFeedContentGz = <ThrowOnError extends boolean = false>(options: Options<DownloadFeedContentGzData, ThrowOnError>): RequestResult<DownloadFeedContentGzResponses, DownloadFeedContentGzErrors, ThrowOnError> => (options.client ?? client).get<DownloadFeedContentGzResponses, DownloadFeedContentGzErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 * This endpoint does not require authentication. It is intended for use by package managers running on managed systems.
 */
export const headFeedContentGz = <ThrowOnError extends boolean = false>(options: Options<HeadFeedContentGzData, ThrowOnError>): RequestResult<HeadFeedContentGzResponses, HeadFeedContentGzErrors, ThrowOnError> => (options.client ?? client).head<HeadFeedContentGzResponses, HeadFeedContentGzErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/nifeed/v1/feeds/{feedId}/files/Packages.gz',
    ...options
});
 ...
 * This endpoint does not require authentication. It is intended for use by package managers running on managed systems.
 */
export const downloadFeedContent = <ThrowOnError extends boolean = false>(options: Options<DownloadFeedContentData, ThrowOnError>): RequestResult<DownloadFeedContentResponses, DownloadFeedContentErrors, ThrowOnError> => (options.client ?? client).get<DownloadFeedContentResponses, DownloadFeedContentErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 * This endpoint does not require authentication. It is intended for use by package managers running on managed systems.
 */
export const headFeedContent = <ThrowOnError extends boolean = false>(options: Options<HeadFeedContentData, ThrowOnError>): RequestResult<HeadFeedContentResponses, HeadFeedContentErrors, ThrowOnError> => (options.client ?? client).head<HeadFeedContentResponses, HeadFeedContentErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/nifeed/v1/feeds/{feedId}/files/Packages',
    ...options
});
 ...
 */
export const queryJobsForFeed = <ThrowOnError extends boolean = false>(options: Options<QueryJobsForFeedData, ThrowOnError>): RequestResult<QueryJobsForFeedResponses, QueryJobsForFeedErrors, ThrowOnError> => (options.client ?? client).get<QueryJobsForFeedResponses, QueryJobsForFeedErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const queryPackagesForFeed = <ThrowOnError extends boolean = false>(options: Options<QueryPackagesForFeedData, ThrowOnError>): RequestResult<QueryPackagesForFeedResponses, QueryPackagesForFeedErrors, ThrowOnError> => (options.client ?? client).get<QueryPackagesForFeedResponses, QueryPackagesForFeedErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const uploadPackageToFeedAsync = <ThrowOnError extends boolean = false>(options: Options<UploadPackageToFeedAsyncData, ThrowOnError>): RequestResult<UploadPackageToFeedAsyncResponses, UploadPackageToFeedAsyncErrors, ThrowOnError> => (options.client ?? client).post<UploadPackageToFeedAsyncResponses, UploadPackageToFeedAsyncErrors, ThrowOnError>({
 ...
 */
export const deletePackageById = <ThrowOnError extends boolean = false>(options: Options<DeletePackageByIdData, ThrowOnError>): RequestResult<DeletePackageByIdResponses, DeletePackageByIdErrors, ThrowOnError> => (options.client ?? client).delete<DeletePackageByIdResponses, DeletePackageByIdErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const getPackageById = <ThrowOnError extends boolean = false>(options: Options<GetPackageByIdData, ThrowOnError>): RequestResult<GetPackageByIdResponses, GetPackageByIdErrors, ThrowOnError> => (options.client ?? client).get<GetPackageByIdResponses, GetPackageByIdErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/nifeed/v1/packages/{packageId}',
    ...options
});
 ...
 */
export const deletePackages = <ThrowOnError extends boolean = false>(options?: Options<DeletePackagesData, ThrowOnError>): RequestResult<DeletePackagesResponses, DeletePackagesErrors, ThrowOnError> => (options?.client ?? client).post<DeletePackagesResponses, DeletePackagesErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
