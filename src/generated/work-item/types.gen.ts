...
export type QueryWorkItemsRequest = {
     ...
     *
     * - <b>state</b>: String enumeration representing the state of the work item. Possible values are: New, Defined, Reviewed, Scheduled, InProgress, PendingApproval, Closed, Canceled.
     *
...
export type ResourceDefinition = {
    ...
    /**
     * Query string specifying the filter criteria for selecting the resources that can be used to carry out the work item.
     */
    filter?: string | null;
};
...
export type ResourcesDefinition = {
    ...
    /**
     * Query language used to interpret the <b>Filter</b> of every resource in this reservation.
     */
    filterType?: 'LUCENE' | 'LINQ';
};
...
export type SystemResourceDefinition = {
    ...
    selections?: Array<SystemResourceSelectionDefinition> | null;
    /**
     * Query string specifying the filter criteria for selecting the systems that can be used to carry out the work item.
     */
    filter?: string | null;
};
...
export type UpdateTemplateResourceDefinition = {
    /**
     * Query string with the filter criteria that matches the list of resources that can be used to carry out the work item.
     */
    filter?: string | null;
};
...
export type WorkItemResponseBase = {
    ...
    workflowId?: string | null;
    /**
     * ID of the work order before migration. Available only on migrated work items of type "workorder" for backward compatibility.
     */
...
export type WorkItemTypeValidationRuleConfig = {
     ...
     */
    fields?: Array<'ID' | 'NAME' | 'TYPE' | 'STATE' | 'SUBSTATE' | 'DESCRIPTION' | 'PARENT_ID' | 'TEMPLATE_ID' | 'ASSIGNED_TO' | 'REQUESTED_BY' | 'TEST_PROGRAM' | 'PART_NUMBER' | 'TIMELINE' | 'TIMELINE.EARLIEST_START_DATE_TIME' | 'TIMELINE.DUE_DATE_TIME' | 'TIMELINE.ESTIMATED_DURATION_IN_SECONDS' | 'SCHEDULE' | 'SCHEDULE.PLANNED_START_DATE_TIME' | 'SCHEDULE.PLANNED_END_DATE_TIME' | 'SCHEDULE.PLANNED_DURATION' | 'RESOURCES' | 'RESOURCES.SYSTEMS' | 'RESOURCES.ASSETS' | 'RESOURCES.DUTS' | 'RESOURCES.FIXTURES' | 'RESOURCES.SYSTEMS.SELECTIONS' | 'RESOURCES.ASSETS.SELECTIONS' | 'RESOURCES.DUTS.SELECTIONS' | 'RESOURCES.FIXTURES.SELECTIONS' | 'RESOURCES.SYSTEMS.SELECTIONS.ID' | 'RESOURCES.SYSTEMS.SELECTIONS.TARGET_LOCATION_ID' | 'RESOURCES.ASSETS.SELECTIONS.ID' | 'RESOURCES.ASSETS.SELECTIONS.TARGET_LOCATION_ID' | 'RESOURCES.ASSETS.SELECTIONS.TARGET_SYSTEM_ID' | 'RESOURCES.ASSETS.SELECTIONS.TARGET_PARENT_ID' | 'RESOURCES.DUTS.SELECTIONS.ID' | 'RESOURCES.DUTS.SELECTIONS.TARGET_LOCATION_ID' | 'RESOURCES.DUTS.SELECTIONS.TARGET_SYSTEM_ID' | 'RESOURCES.DUTS.SELECTIONS.TARGET_PARENT_ID' | 'RESOURCES.FIXTURES.SELECTIONS.ID' | 'RESOURCES.FIXTURES.SELECTIONS.TARGET_LOCATION_ID' | 'RESOURCES.FIXTURES.SELECTIONS.TARGET_SYSTEM_ID' | 'RESOURCES.FIXTURES.SELECTIONS.TARGET_PARENT_ID' | 'RESOURCES.ASSETS.FILTER' | 'RESOURCES.DUTS.FILTER' | 'RESOURCES.FIXTURES.FILTER' | 'RESOURCES.SYSTEMS.FILTER' | 'RESOURCES.FILTER_TYPE' | 'WORKFLOW_ID' | 'WORKFLOW_SNAPSHOT' | 'EXECUTION_ACTIONS' | 'EXECUTION_HISTORY' | 'FILE_IDS_FROM_TEMPLATE' | 'PROPERTIES' | 'DASHBOARD' | 'CREATED_BY' | 'CREATED_AT' | 'UPDATED_BY' | 'UPDATED_AT' | 'WORKSPACE' | 'LEGACY_WORK_ORDER_ID'> | null;
    /**
...
export type GetWorkItemsSummaryData = {
    ...
    query?: {
        /**
         * One or more comma-separated work item types to filter by.
         * The value is case-sensitive and must be a supported work item type.
         * If not specified or null, all work item types are considered.
         */
        type?: string;
    };
...
export type GetWorkItemsSummaryErrors = {
    /**
     * One or more specified work item types are invalid.
     */
    400: unknown;
    /**
     * Unauthorized.
