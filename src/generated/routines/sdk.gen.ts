 ...
 * @deprecated
 */
export const queryRoutines = <ThrowOnError extends boolean = false>(options?: Options<QueryRoutinesData, ThrowOnError>): RequestResult<QueryRoutinesResponses, QueryRoutinesErrors, ThrowOnError> => (options?.client ?? client).get<QueryRoutinesResponses, QueryRoutinesErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 * @deprecated
 */
export const deleteRoutine = <ThrowOnError extends boolean = false>(options: Options<DeleteRoutineData, ThrowOnError>): RequestResult<DeleteRoutineResponses, DeleteRoutineErrors, ThrowOnError> => (options.client ?? client).delete<DeleteRoutineResponses, DeleteRoutineErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 * @deprecated
 */
export const getRoutineById = <ThrowOnError extends boolean = false>(options: Options<GetRoutineByIdData, ThrowOnError>): RequestResult<GetRoutineByIdResponses, GetRoutineByIdErrors, ThrowOnError> => (options.client ?? client).get<GetRoutineByIdResponses, GetRoutineByIdErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/niroutine/v1/routines/{id}',
    ...options
});
 ...
 * @deprecated
 */
export const updateRoutine = <ThrowOnError extends boolean = false>(options: Options<UpdateRoutineData, ThrowOnError>): RequestResult<UpdateRoutineResponses, UpdateRoutineErrors, ThrowOnError> => (options.client ?? client).patch<UpdateRoutineResponses, UpdateRoutineErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/niroutine/v1/routines/{id}',
    ...options,
    headers: {
 ...
 * @deprecated
 */
export const getExecutionDefinitionByRoutineId = <ThrowOnError extends boolean = false>(options: Options<GetExecutionDefinitionByRoutineIdData, ThrowOnError>): RequestResult<GetExecutionDefinitionByRoutineIdResponses, GetExecutionDefinitionByRoutineIdErrors, ThrowOnError> => (options.client ?? client).get<GetExecutionDefinitionByRoutineIdResponses, GetExecutionDefinitionByRoutineIdErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
