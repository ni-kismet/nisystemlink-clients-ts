 ...
 */
export const configureFeeds = <ThrowOnError extends boolean = false>(options?: Options<ConfigureFeedsData, ThrowOnError>): RequestResult<ConfigureFeedsResponses, ConfigureFeedsErrors, ThrowOnError> => (options?.client ?? client).post<ConfigureFeedsResponses, ConfigureFeedsErrors, ThrowOnError>({
 ...
 */
export const queryAvailablePackages = <ThrowOnError extends boolean = false>(options?: Options<QueryAvailablePackagesData, ThrowOnError>): RequestResult<QueryAvailablePackagesResponses, QueryAvailablePackagesErrors, ThrowOnError> => (options?.client ?? client).post<QueryAvailablePackagesResponses, QueryAvailablePackagesErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const queryStoreItems = <ThrowOnError extends boolean = false>(options?: Options<QueryStoreItemsData, ThrowOnError>): RequestResult<QueryStoreItemsResponses, QueryStoreItemsErrors, ThrowOnError> => (options?.client ?? client).get<QueryStoreItemsResponses, QueryStoreItemsErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const getStoreItem = <ThrowOnError extends boolean = false>(options: Options<GetStoreItemData, ThrowOnError>): RequestResult<GetStoreItemResponses, GetStoreItemErrors, ThrowOnError> => (options.client ?? client).get<GetStoreItemResponses, GetStoreItemErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
