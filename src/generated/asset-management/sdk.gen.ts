 ...
 */
export const createAssets = <ThrowOnError extends boolean = false>(options?: Options<CreateAssetsData, ThrowOnError>): RequestResult<CreateAssetsResponses, CreateAssetsErrors, ThrowOnError> => (options?.client ?? client).post<CreateAssetsResponses, CreateAssetsErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/niapm/v1/assets',
    ...options,
    headers: {
 ...
 */
export const assetSummary = <ThrowOnError extends boolean = false>(options?: Options<AssetSummaryData, ThrowOnError>): RequestResult<AssetSummaryResponses, AssetSummaryErrors, ThrowOnError> => (options?.client ?? client).get<AssetSummaryResponses, AssetSummaryErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const updateAssets = <ThrowOnError extends boolean = false>(options?: Options<UpdateAssetsData, ThrowOnError>): RequestResult<UpdateAssetsResponses, UpdateAssetsErrors, ThrowOnError> => (options?.client ?? client).post<UpdateAssetsResponses, UpdateAssetsErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const queryAssetLocationHistory = <ThrowOnError extends boolean = false>(options: Options<QueryAssetLocationHistoryData, ThrowOnError>): RequestResult<QueryAssetLocationHistoryResponses, QueryAssetLocationHistoryErrors, ThrowOnError> => (options.client ?? client).post<QueryAssetLocationHistoryResponses, QueryAssetLocationHistoryErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const deleteAssets = <ThrowOnError extends boolean = false>(options?: Options<DeleteAssetsData, ThrowOnError>): RequestResult<DeleteAssetsResponses, DeleteAssetsErrors, ThrowOnError> => (options?.client ?? client).post<DeleteAssetsResponses, DeleteAssetsErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const linkFiles = <ThrowOnError extends boolean = false>(options: Options<LinkFilesData, ThrowOnError>): RequestResult<LinkFilesResponses, LinkFilesErrors, ThrowOnError> => (options.client ?? client).post<LinkFilesResponses, LinkFilesErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const unlinkFileFromAsset = <ThrowOnError extends boolean = false>(options: Options<UnlinkFileFromAssetData, ThrowOnError>): RequestResult<UnlinkFileFromAssetResponses, UnlinkFileFromAssetErrors, ThrowOnError> => (options.client ?? client).delete<UnlinkFileFromAssetResponses, UnlinkFileFromAssetErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const deleteCalibrationHistory = <ThrowOnError extends boolean = false>(options: Options<DeleteCalibrationHistoryData, ThrowOnError>): RequestResult<DeleteCalibrationHistoryResponses, DeleteCalibrationHistoryErrors, ThrowOnError> => (options.client ?? client).post<DeleteCalibrationHistoryResponses, DeleteCalibrationHistoryErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const getAssetCalibrationHistory = <ThrowOnError extends boolean = false>(options: Options<GetAssetCalibrationHistoryData, ThrowOnError>): RequestResult<GetAssetCalibrationHistoryResponses, GetAssetCalibrationHistoryErrors, ThrowOnError> => (options.client ?? client).get<GetAssetCalibrationHistoryResponses, GetAssetCalibrationHistoryErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const calculateCalibrationForecast = <ThrowOnError extends boolean = false>(options?: Options<CalculateCalibrationForecastData, ThrowOnError>): RequestResult<CalculateCalibrationForecastResponses, CalculateCalibrationForecastErrors, ThrowOnError> => (options?.client ?? client).post<CalculateCalibrationForecastResponses, CalculateCalibrationForecastErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const receiveFromCalibrationDryRun = <ThrowOnError extends boolean = false>(options?: Options<ReceiveFromCalibrationDryRunData, ThrowOnError>): RequestResult<ReceiveFromCalibrationDryRunResponses, ReceiveFromCalibrationDryRunErrors, ThrowOnError> => (options?.client ?? client).post<ReceiveFromCalibrationDryRunResponses, ReceiveFromCalibrationDryRunErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const receiveFromCalibration = <ThrowOnError extends boolean = false>(options?: Options<ReceiveFromCalibrationData, ThrowOnError>): RequestResult<ReceiveFromCalibrationResponses, ReceiveFromCalibrationErrors, ThrowOnError> => (options?.client ?? client).post<ReceiveFromCalibrationResponses, ReceiveFromCalibrationErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const sendForCalibrationDryRun = <ThrowOnError extends boolean = false>(options?: Options<SendForCalibrationDryRunData, ThrowOnError>): RequestResult<SendForCalibrationDryRunResponses, SendForCalibrationDryRunErrors, ThrowOnError> => (options?.client ?? client).post<SendForCalibrationDryRunResponses, SendForCalibrationDryRunErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 * the request.
 */
export const sendForCalibration = <ThrowOnError extends boolean = false>(options?: Options<SendForCalibrationData, ThrowOnError>): RequestResult<SendForCalibrationResponses, SendForCalibrationErrors, ThrowOnError> => (options?.client ?? client).post<SendForCalibrationResponses, SendForCalibrationErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const moveAssetsLocationDryRun = <ThrowOnError extends boolean = false>(options?: Options<MoveAssetsLocationDryRunData, ThrowOnError>): RequestResult<MoveAssetsLocationDryRunResponses, MoveAssetsLocationDryRunErrors, ThrowOnError> => (options?.client ?? client).post<MoveAssetsLocationDryRunResponses, MoveAssetsLocationDryRunErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const moveAssetsLocation = <ThrowOnError extends boolean = false>(options?: Options<MoveAssetsLocationData, ThrowOnError>): RequestResult<MoveAssetsLocationResponses, MoveAssetsLocationErrors, ThrowOnError> => (options?.client ?? client).post<MoveAssetsLocationResponses, MoveAssetsLocationErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const queryLocationMoves = <ThrowOnError extends boolean = false>(options?: Options<QueryLocationMovesData, ThrowOnError>): RequestResult<QueryLocationMovesResponses, QueryLocationMovesErrors, ThrowOnError> => (options?.client ?? client).post<QueryLocationMovesResponses, QueryLocationMovesErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const searchAssets = <ThrowOnError extends boolean = false>(options?: Options<SearchAssetsData, ThrowOnError>): RequestResult<SearchAssetsResponses, SearchAssetsErrors, ThrowOnError> => (options?.client ?? client).post<SearchAssetsResponses, SearchAssetsErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const exportMaterializedAssets = <ThrowOnError extends boolean = false>(options?: Options<ExportMaterializedAssetsData, ThrowOnError>): RequestResult<ExportMaterializedAssetsResponses, ExportMaterializedAssetsErrors, ThrowOnError> => (options?.client ?? client).post<ExportMaterializedAssetsResponses, ExportMaterializedAssetsErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const startUtilization = <ThrowOnError extends boolean = false>(options?: Options<StartUtilizationData, ThrowOnError>): RequestResult<StartUtilizationResponses, StartUtilizationErrors, ThrowOnError> => (options?.client ?? client).post<StartUtilizationResponses, StartUtilizationErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const endUtilization = <ThrowOnError extends boolean = false>(options?: Options<EndUtilizationData, ThrowOnError>): RequestResult<EndUtilizationResponses, EndUtilizationErrors, ThrowOnError> => (options?.client ?? client).post<EndUtilizationResponses, EndUtilizationErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const utilizationHeartbeat = <ThrowOnError extends boolean = false>(options?: Options<UtilizationHeartbeatData, ThrowOnError>): RequestResult<UtilizationHeartbeatResponses, UtilizationHeartbeatErrors, ThrowOnError> => (options?.client ?? client).post<UtilizationHeartbeatResponses, UtilizationHeartbeatErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
 ...
 */
export const rootEndpoint = <ThrowOnError extends boolean = false>(options?: Options<RootEndpointData, ThrowOnError>): RequestResult<RootEndpointResponses, RootEndpointErrors, ThrowOnError> => (options?.client ?? client).get<RootEndpointResponses, RootEndpointErrors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/niapm',
    ...options
});
 ...
 */
export const v1 = <ThrowOnError extends boolean = false>(options?: Options<V1Data, ThrowOnError>): RequestResult<V1Responses, V1Errors, ThrowOnError> => (options?.client ?? client).get<V1Responses, V1Errors, ThrowOnError>({
    security: [{ name: 'X-NI-API-KEY', type: 'apiKey' }],
    url: '/niapm/v1',
    ...options
});
